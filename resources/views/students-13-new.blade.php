        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 section-heading text-center to-animate">
                    ...
                    <a href="{{route('students_1')}}" class="text-center" style="font-size: 0.7em">View Batch 12</a>
                </div>
                </div>
        </div>
        <div class="fh5co-explore fh5co-explore-bg-color">
            <div class="container to-animate">
                        ...
                        <div class="list-item to-animate">
                            <div class="row">
                                @if(file_exists(public_path('profilepics_13/'.$student->user->name.'.jpg')))
                                <div class="col-lg-2"><img class="img-circle img-responsive center-block" src="{{asset('profilepics_13').'/'.$student->user->name.'.jpg'}}" alt=""></div>
                                @else
                            ...
                            dataObj.forEach(function(element) {
                                ...
                                var hitTemplate =
                                        '<div class="list-item ">' +
                                            '<div class="row">' +
                                                '<div class="col-lg-2">' +
                                                    '<img class="img-circle img-responsive"  src="/profilepics_13/@{{profile_img}}" alt="icon">' +
                                                '</div>' +
                                                '<div class="col-lg-9">' +
