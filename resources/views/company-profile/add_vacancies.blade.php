                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-8"> <textarea rows="5" class="login-inbox center-block" style="width: 95%; color:black;" placeholder="you have 50 - 500 characters to tell about job responsibility" name="responsibility">{{ old('responsibility') }}</textarea> 
